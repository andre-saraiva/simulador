...
set output 'dc_teste2.png' # setando o nome da saída
...
plot "teste-DC-2-er.dat" using ($1):($2) title "DC 10.98%" with linespoints ls 1, \
"teste-DC-2-er.dat" using ($1):($2):($3) notitle with yerrorbars,\
"teste-DC-2-er.dat" using ($1):($4) title "DC 9.02%" with linespoints ls 2, \
"teste-DC-2-er.dat" using ($1):($4):($5) notitle with yerrorbars,\
"teste-DC-2-er.dat" using ($1):($6) title "DC 7.65%"  with linespoints ls 3, \
"teste-DC-2-er.dat" using ($1):($6):($7) notitle with yerrorbars,\
"teste-DC-2-er.dat" using ($1):($8) title "DC 6.22%"  with linespoints ls 4, \
"teste-DC-2-er.dat" using ($1):($8):($9) notitle with yerrorbars,\
